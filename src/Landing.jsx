...
import CustomCursor from "./Effects/CustomCursor"; // Or your actual path
...
const Landing = () => {
  ...
  // Navigation items - This was already good, no duplicate "Home" here.
  // The visual duplicate in the screenshot is likely a GooeyNav rendering behavior.
  const navItems = [
  ...
  // ... (rest of your certifications, techStack, sendEmail, useEffect for GSAP)
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white relative selection:bg-indigo-500 selection:text-white">
      ...
      <header className="sticky top-0 z-50 bg-black/70 backdrop-blur-md shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center py-4 px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="flex items-center space-x-3 cursor-pointer-interactive" // Added class for cursor
          >
            <img
              src="/logo.webp"
              alt="Rohith's Logo"
          ...
          {/* Ensure GooeyNav renders navItems correctly without duplication */}
          <div className="hidden md:flex items-center space-x-1">
            ...
            >
              {/* Pass handleNavClick to GooeyNav if it supports it, otherwise its internal links should also trigger cursor change */}
              <GooeyNav
                items={navItems}
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden bg-black/90 border-t border-gray-700/50"
            >
              <nav className="px-4 pt-4 pb-3 space-y-1">
                {navItems.map((item, index) => (
                  <motion.a
                    ...
                    className="block text-white text-lg px-3 py-3 rounded-md hover:bg-indigo-600/30 transition-colors duration-200 cursor-pointer-interactive" // Added class
      ...
      <main className="flex-grow">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
            ...
            <motion.div
              ...
              className="mt-6 h-12"
            >
              {/* InteractiveText component will also need cursor:none if it has its own hover states or if you want the custom cursor to take over. */}
              {/* If it's just text, it will be handled by the 'text' variant of the custom cursor. */}
            ...
            >
              <a
                ...
                // The custom cursor will automatically apply to <a> tags
        ...
        {/* ... (Rest of your sections: About Me, Tech Stack, Projects, Experience, Certifications, Get Quote) */}
        {/* Remember to add `cursor-pointer-interactive` to any other custom interactive components if needed, */}
        {/* or rely on the default <a> and <button> selectors in CustomCursor.js */}
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <p className="text-xl text-gray-200 leading-relaxed">
                ...
                Passionate about technology’s ever-evolving landscape, I
                constantly explore new trends, frameworks, and innovations to
        ...
        <section
          id="tech-stack"
          className="relative py-24 md:py-28 bg-black overflow-hidden"
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 lg:gap-8 place-items-center">
              {techStack.map((tech, index) => (
                <motion.div
                  key={tech.name}
                  className="group relative p-6 w-full h-56 rounded-xl bg-neutral-900 hover:bg-neutral-800/70 border border-neutral-800 hover:border-cyan-500/50 transition-all duration-300 ease-out flex flex-col items-center justify-center cursor-pointer-interactive" // Added cursor class
                ...
                >
                  ...
                  <motion.img
                    src={tech.icon}
                    alt={tech.name}
                    className="h-14 w-14 sm:h-16 sm:w-16 object-contain mb-3 group-hover:scale-110 group-hover:drop-shadow-[0_0_10px_rgba(34,211,238,0.5)] transition-all duration-300"
                  />
            ...
            <motion.div
              className="mt-20 md:mt-24 mx-auto w-1/2 h-px bg-gradient-to-r from-transparent via-cyan-500/50 to-transparent"
              initial={{ scaleX: 0 }}
            ...
            >
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                <a
                  href="#projects"
                  onClick={(e) => handleNavClick(e, "#projects")}
                  className="px-7 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg font-semibold text-white hover:scale-105 transition-transform duration-300 shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/40 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                >
                  See Projects
                </a>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-neutral-700/70 pt-4 mt-auto">
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="w-5 h-5 mr-2 transition-transform group-hover/link:scale-110"
                      >
                        <path
                          fillRule="evenodd"
            ...
            >
              ...
              >
                <TiltedCard
                  ...
                  className="shadow-xl group-hover:shadow-2xl group-hover:shadow-indigo-500/30 transition-all duration-300 cursor-pointer-interactive" // Added cursor class
                />
              </a>
            </motion.div>
          </div>
        ...
        <section id="certifications" className="py-20 bg-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.div
                className="mt-8 h-1.5 bg-gradient-to-r from-blue-500 to-purple-600 w-32 mx-auto rounded-full"
                initial={{ scaleX: 0 }}
                whileInView={{ scaleX: 1 }}
              ...
              {certifications.map((cert, idx) => (
                ...
                >
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex flex-col bg-gradient-to-br from-neutral-900 to-black rounded-xl overflow-hidden shadow-lg hover:shadow-xl hover:shadow-indigo-500/30 transition-all duration-400 h-full border border-neutral-800 hover:border-indigo-500/70 cursor-pointer-interactive" // Added cursor class
                  >
        ...
        <section
          id="get-quote"
          className="relative py-20 md:py-24 bg-black text-white text-center overflow-hidden"
        >
          <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-80">
            <motion.div
              className="absolute -top-40 -left-40 w-96 h-96 md:w-[500px] md:h-[500px] bg-gradient-to-r from-indigo-500/25 to-purple-500/25 rounded-full blur-3xl"
            ...
            />
            <motion.div
              className="absolute -bottom-40 -right-40 w-96 h-96 md:w-[500px] md:h-[500px] bg-gradient-to-l from-purple-500/25 to-pink-500/25 rounded-full blur-3xl"
              initial={{ scale: 0.7, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
          ...
          <div className="relative z-10 max-w-2xl mx-auto px-4">
            ...
            <motion.p
              ...
              viewport={{ once: true, amount: 0.5 }}
            >
              Let's collaborate to create something extraordinary. Reach out
              today!
            </motion.p>
      ...
      <footer className="bg-black border-t border-neutral-800/70">
        <div className="max-w-7xl mx-auto py-10 sm:py-12 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            ...
            >
              © {new Date().getFullYear()} Rohith Vittamraj. All rights
              reserved.
            </motion.p>
