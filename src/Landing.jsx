...
const Landing = () => {
  ...
  /**
   * @state {boolean} logoAnimationComplete - Controls whether the logo animation has finished.
   */
  ...
  useEffect(() => {
    ...
    const cycleDuration = 200; // milliseconds per logo
    ...
    const cycleLogos = () => {
      if (currentIndex < totalLogos) {
        ...
        // After cycling through all logos, show the actual logo
        setTimeout(() => {
    ...
    // Start the animation
    const startAnimation = setTimeout(cycleLogos, 1000); // Start after 1 second
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center py-3.5 px-4 sm:px-6 lg:px-8">
          ...
          >
                ...
                {!logoAnimationComplete ? (
                  ...
                  >
                    <img 
                      ...
                      className="w-8 h-8 sm:w-9 sm:h-9 object-contain rounded-lg border border-indigo-500/40 bg-white/5 p-1"
                    />
                  </motion.div>
                ) : (
                  <motion.img 
            ...
            <motion.h1 
              ...
              className="text-xl sm:text-2xl font-semibold text-gray-100 group-hover:text-white transition-colors duration-300 tracking-tight"
            >
              Rohith's Portfolio
            </motion.h1>
          </motion.a>
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
            <motion.div 
              initial={{ opacity: 0, y: -20 }} 
              animate={{ opacity: 1, y: 0 }} 
              transition={{ duration: 0.8, delay: logoAnimationComplete ? 0.3 : 2, ease: "circOut" }} 
            >
            ...
            <motion.div 
              initial={{ opacity: 0, y: 20 }} 
              animate={{ opacity: 1, y: 0 }} 
              transition={{ duration: 0.7, delay: logoAnimationComplete ? 0.8 : 2.2, ease: "circOut" }} 
            ...
            <motion.p 
              initial={{ opacity: 0, y: 20 }} 
              animate={{ opacity: 1, y: 0 }} 
              transition={{ duration: 0.7, delay: logoAnimationComplete ? 1.0 : 2.4, ease: "circOut" }}
            ...
            <motion.div 
              ...
              transition={{ duration: 0.7, delay: logoAnimationComplete ? 1.2 : 2.6, type: "spring", stiffness:150, damping: 20 }}
