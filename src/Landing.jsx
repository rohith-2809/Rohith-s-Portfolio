...
const Landing = () => {
  ...
  const techStack = [
    { 
      ...
      description: "Neural networks for AI solutions"
    },
    { 
      name: "Express.js", 
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <p className="text-lg md:text-xl text-gray-200/95 leading-relaxed">
                I blend cutting-edge technology with creative thinking to build digital
                experiences that solve real problems. With deep expertise in{" "}
                ...
                <span className="font-semibold text-purple-400">UI/UX design</span>, I
                thrive on pushing the boundaries of what's possible. Passionate about
                technology's ever-evolving landscape, I constantly explore new trends,
                frameworks, and innovations to stay ahead of the curve.
              </p>
            </motion.div>
            <motion.div
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            >
              <div className="mb-16 md:mb-20">
                ...
                <p className="text-gray-300/90 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
                  Combining cutting-edge technologies with modern development practices to
                  create{" "}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 md:gap-6 place-items-center">
              {techStack.map((tech, index) => (
                <motion.div
                  key={tech.name}
                  className="group relative p-5 w-full h-60 md:h-64 rounded-xl bg-neutral-900/80 hover:bg-neutral-800/60 border border-neutral-800/70 hover:border-cyan-500/60 transition-all duration-300 ease-out flex flex-col items-center justify-center cursor-pointer-interactive shadow-lg hover:shadow-cyan-500/10"
                ...
                >
                  <motion.img
                    ...
                    loading="lazy"
                  />
                  <h3 className="text-base sm:text-lg font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent group-hover:from-cyan-300 group-hover:to-blue-300 transition-all duration-300 mb-2">
                    {tech.name}
                  </h3>
                  <p className="text-gray-400/90 text-sm mt-1.5 group-hover:text-gray-300 transition-colors font-medium text-center px-2">
                    {tech.description}
                  </p>
                </motion.div>
              ))}
            ...
            >
              <p className="text-gray-300/90 text-lg max-w-3xl mx-auto leading-relaxed">
                Every tool in my arsenal is carefully selected for its performance,
                ecosystem, and maintainability. I specialize in creating full-stack
                solutions that leverage AI capabilities while maintaining{" "}
                ...
                <SpotlightCard className="p-6 flex flex-col justify-between h-full bg-neutral-900/80 hover:bg-neutral-800/70 border border-neutral-800/80 hover:border-indigo-500/60 rounded-xl shadow-xl hover:shadow-indigo-500/20 transition-all duration-300 ease-in-out group cursor-pointer-interactive w-full">
                  <div>
                    ...
                    <p className="text-gray-300/90 leading-relaxed mb-6 text-sm">
                      AI-powered web application that identifies plant diseases from
                      images using CNN models. Provides detailed analysis and preventive
                      measures.
                    </p>
                  </div>
              ...
              >
                <SpotlightCard className="p-6 flex flex-col justify-between h-full bg-neutral-900/80 hover:bg-neutral-800/70 border border-neutral-800/80 hover:border-emerald-500/60 rounded-xl shadow-xl hover:shadow-emerald-500/20 transition-all duration-300 ease-in-out group cursor-pointer-interactive w-full">
                  <div>
                    ...
                    <p className="text-gray-300/90 leading-relaxed mb-6 text-sm">
                      An intelligent agent that automates software documentation by
                      generating UML diagrams and code explanations directly from a given
                      codebase.
                    </p>
                  </div>
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-neutral-700/60 pt-4 mt-auto">
              ...
              >
                <SpotlightCard className="p-6 flex flex-col justify-between h-full bg-neutral-900/80 hover:bg-neutral-800/70 border border-neutral-800/80 hover:border-teal-500/60 rounded-xl shadow-xl hover:shadow-teal-500/20 transition-all duration-300 ease-in-out group cursor-pointer-interactive w-full">
                  <div>
                    ...
                    <p className="text-gray-300/90 leading-relaxed mb-6 text-sm">
                      End-to-end MLOps solution deploying machine learning models via
                      Hugging Face and Flask APIs. Demonstrates real-time predictions.
                    </p>
                  </div>
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-neutral-700/60 pt-4 mt-auto">
                    <a
              ...
              >
                <SpotlightCard className="p-6 flex flex-col justify-between h-full bg-neutral-900/80 hover:bg-neutral-800/70 border border-neutral-800/80 hover:border-purple-500/60 rounded-xl shadow-xl hover:shadow-purple-500/20 transition-all duration-300 ease-in-out group cursor-pointer-interactive w-full">
                  <div>
                    ...
                    <p className="text-gray-300/90 leading-relaxed mb-6 text-sm">
                      A fast, responsive app built with React, Tailwind, and Vite to
                      manage employee data using local storage — no backend needed.
                    </p>
                  </div>
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-neutral-700/60 pt-4 mt-auto">
                    <a
        ...
        <section id="experience" className="py-20 md:py-24 bg-black text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              transition={{ duration: 0.6, ease: "easeOut" }}
              viewport={{ once: true, amount: 0.3 }}
              className="text-4xl md:text-5xl font-bold mb-10 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent relative group"
            >
              My Experience
              <span className="absolute bottom-0 left-1/2 w-36 h-1 bg-gradient-to-r from-indigo-500 to-purple-500 transform -translate-x-1/2 translate-y-2.5 opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-full group-hover:w-40 ease-out"></span>
            </motion.h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <p className="text-lg text-gray-300/90 leading-relaxed">
                ...
                technologies. Each represents 100+ hours of coursework, hands-on projects,
