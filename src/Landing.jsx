          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto">
              <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
                className="bg-neutral-900/80 backdrop-blur-sm rounded-xl border border-neutral-800/80 hover:border-indigo-500/50 transition-all duration-300 overflow-hidden shadow-xl hover:shadow-indigo-500/20 flex flex-col md:flex-row"
              >
