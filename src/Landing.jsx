...
import { FaBars, FaTimes, FaEnvelope, FaPhone, FaMapMarkerAlt, FaPaperPlane } from "react-icons/fa";
...
const GradientBorder = ({ children, className = "" }) => {
  return (
    <div className={`relative p-[1px] ${className}`}>
      <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg opacity-50 blur-sm" />
...
const Landing = () => {
  ...
  const contactInfo = [
    { icon: <FaEnvelope />, text: "rohithvittamraj@gmail.com", href: "mailto:rohithvittamraj@gmail.com" },
    { icon: <FaPhone />, text: "+91 7675984418", href: "tel:+917675984418" },
    { icon: <FaMapMarkerAlt />, text: "Chennai, India", href: "#" },
  ];
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      if (hero) {
        ...
        // Hero text reveal
        gsap.utils.toArray(".hero-text-anim").forEach((text, i) => {
          gsap.fromTo(text,
            { opacity: 0, y: 50 },
            {
              opacity: 1,
        ...
        <AnimatePresence>
          {mainMenuOpen && (
            <motion.div
              ...
              className="absolute top-full left-0 right-0 bg-black/95 backdrop-blur-md border-t border-b border-neutral-800/70 shadow-2xl md:rounded-b-lg md:mx-4 lg:mx-auto lg:max-w-md md:right-4 md:left-auto"
            >
              <nav className="px-4 py-4 space-y-2">
                {navItems.map((item, index) => (
                  <motion.a
                    ...
                    className="block text-gray-200 hover:text-white px-4 py-2.5 rounded-lg hover:bg-indigo-600/40 transition-all duration-200 relative overflow-hidden group"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/0 to-indigo-600/20 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300" />
                  </motion.a>
                ))}
              </nav>
            </motion.div>
      ...
      >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
            ...
            >
              <motion.a 
                ...
                className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-3.5 rounded-lg text-base font-semibold hover:from-indigo-500 hover:to-purple-500 transition-all duration-300 transform hover:scale-105 relative overflow-hidden group"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <span className="relative z-10">Explore My Work ✨</span>
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-purple-500 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300" />
              </motion.a>
              
              <motion.button
                onClick={() => setContactModalOpen(true)}
                className="inline-block border-2 border-indigo-500/50 text-indigo-400 px-8 py-3.5 rounded-lg text-base font-semibold hover:bg-indigo-500/10 hover:border-indigo-400 transition-all duration-300 transform hover:scale-105"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Get In Touch
            ...
            >
              <motion.div
                ...
                className="w-6 h-10 border-2 border-indigo-500/50 rounded-full flex justify-center"
              >
        ...
        <section id="about" className="py-20 md:py-24 bg-black relative overflow-hidden">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <GradientBorder className="mb-12">
              <motion.div 
                initial={{ opacity: 0, y: 20 }} 
                whileInView={{ opacity: 1, y: 0 }} 
                transition={{ duration: 0.6, ease: "easeOut", delay: 0.15 }} 
                viewport={{ once: true, amount: 0.3 }}
                className="p-8 bg-black/90 backdrop-blur-sm rounded-lg"
              >
            ...
            >
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mr-2.5 group-hover:rotate-12 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <section id="tech-stack" className="relative py-20 md:py-28 bg-black overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            <motion.div
              className="absolute w-[500px] h-[500px] bg-gradient-to-r from-cyan-600/25 to-blue-600/25 rounded-full blur-3xl -top-32 -left-32"
              animate={{
                scale: [1, 1.1, 1],
                rotate: [0, 180, 360],
              }}
            ...
            />
            <motion.div
              className="absolute w-[400px] h-[400px] bg-gradient-to-r from-purple-600/25 to-pink-600/25 rounded-full blur-3xl -bottom-32 -right-32"
              animate={{
                scale: [1, 1.2, 1],
                rotate: [360, 180, 0],
              }}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 md:gap-6 place-items-center">
              {techStack.map((tech, index) => (
                <motion.div
                  key={tech.name}
                  className="tech-card group relative p-5 w-full h-52 md:h-56 rounded-xl bg-neutral-900/80 hover:bg-neutral-800/60 border border-neutral-800/70 hover:border-cyan-500/60 transition-all duration-300 ease-out flex flex-col items-center justify-center cursor-pointer-interactive shadow-lg hover:shadow-cyan-500/10"
            ...
            >
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                ...
                <motion.button 
                  className="px-7 py-3 border-2 border-cyan-500/40 text-cyan-400 rounded-lg font-semibold hover:border-cyan-400/70 hover:bg-cyan-500/10 transition-all duration-300 hover:text-cyan-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-500/50"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Tech Insights
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 place-items-stretch">
              ...
              <motion.div 
                ...
                viewport={{ once: true, amount: 0.2 }} 
                className="h-full flex project-card"
              >
                <SpotlightCard className="p-6 flex flex-col justify-between h-full bg-neutral-900/80 hover:bg-neutral-800/70 border border-neutral-800/80 hover:border-indigo-500/60 rounded-xl shadow-xl hover:shadow-indigo-500/20 transition-all duration-300 ease-in-out group cursor-pointer-interactive w-full">
                  <div>
                    ...
                    <p className="text-gray-300/90 leading-relaxed mb-6 text-sm">
                      AI-powered web application that identifies plant diseases from images using CNN models. 
                      Provides detailed analysis and preventive measures.
                    </p>
                  </div>
              ...
              >
                <SpotlightCard className="p-6 flex flex-col justify-between h-full bg-neutral-900/80 hover:bg-neutral-800/70 border border-neutral-800/80 hover:border-emerald-500/60 rounded-xl shadow-xl hover:shadow-emerald-500/20 transition-all duration-300 ease-in-out group cursor-pointer-interactive w-full">
                  <div>
                    ...
                    <p className="text-gray-300/90 leading-relaxed mb-6 text-sm">
                      An intelligent agent that automates software documentation by generating UML diagrams 
                      and code explanations directly from a given codebase.
                    </p>
                  </div>
              ...
              >
                <SpotlightCard className="p-6 flex flex-col justify-between h-full bg-neutral-900/80 hover:bg-neutral-800/70 border border-neutral-800/80 hover:border-teal-500/60 rounded-xl shadow-xl hover:shadow-teal-500/20 transition-all duration-300 ease-in-out group cursor-pointer-interactive w-full">
                  <div>
                    ...
                    <p className="text-gray-300/90 leading-relaxed mb-6 text-sm">
                      End-to-end MLOps solution deploying machine learning models via Hugging Face and Flask APIs. 
                      Demonstrates real-time predictions.
                    </p>
                  </div>
              ...
              >
                <SpotlightCard className="p-6 flex flex-col justify-between h-full bg-neutral-900/80 hover:bg-neutral-800/70 border border-neutral-800/80 hover:border-purple-500/60 rounded-xl shadow-xl hover:shadow-purple-500/20 transition-all duration-300 ease-in-out group cursor-pointer-interactive w-full">
                  <div>
                    ...
                    <p className="text-gray-300/90 leading-relaxed mb-6 text-sm">
                      A fast, responsive app built with React, Tailwind, and Vite to manage employee data 
                      using local storage — no backend needed.
                    </p>
                  </div>
                  
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-neutral-700/60 pt-4 mt-auto">
                    <motion.a 
                      href="https://github.com/rohith-2809/Employee_management_system" 
                      target="_blank" 
                      rel="noopener noreferrer" 
        ...
        <section id="experience" className="py-20 md:py-24 bg-black text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              I focused on crafting clean, responsive interfaces, optimizing performance, 
              and building seamless API integrations that connected every layer of the system effortlessly.
            </motion.p>
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0, scale: 1 }} 
              viewport={{ once: true, amount: 0.2 }} 
              transition={{ duration: 0.7, ease: "circOut", delay: 0.2, type: "spring", stiffness: 120 }} 
            >
        ...
        <section id="certifications" className="py-20 md:py-24 bg-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent relative group section-title">
        ...
        <section id="get-quote" className="relative py-20 md:py-28 bg-black text-white text-center overflow-hidden">
          <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-90">
            <motion.div
              className="absolute -top-40 -left-40 w-96 h-96 md:w-[550px] md:h-[550px] bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-full blur-3xl"
              animate={{
                x: [0, 50, 0],
                y: [0, -30, 0],
                scale: [1, 1.1, 1],
          ...
          <div className="relative z-10 max-w-2xl mx-auto px-4">
            <motion.h2 
              className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent section-title"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: "easeOut" }}
              viewport={{ once: true, amount: 0.5 }}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  {contactInfo.map((info, idx) => (
                    <motion.a
                      key={idx}
                      href={info.href}
                      className="flex items-center gap-3 text-gray-300 hover:text-white p-2 rounded-lg hover:bg-neutral-800/50 transition-all duration-200"
                      whileHover={{ x: 5 }}
                ...
                <form className="space-y-5" onSubmit={sendEmail}>
                  {[
                    ...
                    <div key={field.name}>
                      <label htmlFor={field.name} className="block text-sm font-medium text-gray-300/90 mb-1.5 text-left">
                      ...
                      <input
                        ...
                        id={field.name}
                        required
                        className="w-full px-4 py-2.5 bg-neutral-800/60 border border-neutral-700/80 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-gray-500/90 text-gray-100 transition-all duration-200 text-sm focus:bg-neutral-800"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-gray-300/90 mb-1.5 text-left">
                      Message
                    </label>
                    <textarea
                      id="message"
                  ...
                  {formStatus.message && (
                    <motion.div
                      initial={{ opacity: 0, y: -10 }}
                      animate={{ opacity: 1, y: 0 }}
                      className={`p-3 rounded-lg text-sm ${formStatus.type === 'success' ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'}`}
                    >
                      {formStatus.message}
                    </motion.div>
                  )}
      ...
      <footer className="bg-black border-t border-neutral-800/60">
        <div className="max-w-7xl mx-auto py-8 sm:py-10 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            ...
            >
              {[
                { href: "https://x.com/rohithofficial5?s=21&t=cVo-4UEJaqOqaL-meqeikQ", label: "Twitter", hoverClasses: "hover:bg-sky-500/90 hover:shadow-sky-500/30" },
                { href: "https://www.instagram.com/_rohtzz_", label: "Instagram", hoverClasses: "hover:bg-pink-500/90 hover:shadow-pink-500/30" },
                { href: "https://www.linkedin.com/in/rohith-vittamraj-0ab76a313", label: "LinkedIn", hoverClasses: "hover:bg-blue-600/90 hover:shadow-blue-600/30" },
                { href: "https://github.com/rohith-2809", label: "GitHub", hoverClasses: "hover:bg-neutral-700/90 hover:shadow-white/10" },
              ].map((social, idx) => (
                <motion.a
                  key={social.label}
                  href={social.href}
